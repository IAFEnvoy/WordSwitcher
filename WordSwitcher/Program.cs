...
namespace WordSwitcher
{
    internal static class Program
    {
        ...
        static string wps = @"C:\Users\Administrator\AppData\Local\Kingsoft\WPS Office\11.1.0.11194\office6\wps.exe";
        /// <summary>
        /// 应用程序的主入口点。
        /// </summary>
        [STAThread]
        static void Main(string[] args)
        {
            ...
            else
            {
                ...
                for (int i = 0; i <= 10; i++)
                    if (today >= start[i].AddMinutes(-5) && today <= start[i].AddMinutes(45))//前后各5分钟缓冲
                    {
                        int weekday;
